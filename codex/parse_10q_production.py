...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Parse gold and silver production ounces from SEC filings and imported Exhibit 99.3 reports."
    )
